    ...
    <div class="flex gap-2 w-full h-[730px]">
        ...
        <div class="basis-[65%] h-full overflow-auto">
            <DataTable
             ...
             <Column field="qty"        header="기준생산량"    :style="{ width: '120px' , textAlign: 'center'}"  :pt="{ columnHeaderContent: 'justify-center' }"/>
             <Column field="recipeQty"  header="소요량"   :style="{ width: '130px' , textAlign: 'center'}"  :pt="{ columnHeaderContent: 'justify-center' }"/>
             </DataTable>
        </div>
    </div>
</div>

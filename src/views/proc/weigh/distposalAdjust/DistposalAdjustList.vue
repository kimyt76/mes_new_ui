...
import DistposalAdjustPop from '@/views/proc/weigh/distposalAdjust/DistposalAdjustPop.vue';
...
const selectRowClick = (id) =>{
    ...
    dialog.open(DistposalAdjustPop, {
        props: {
            header:title,
            modal:true,
            draggable: true,
...
const downloadExcel = () =>{
  ...
  exportToExcel(adjustList.value, "폐기조정 리스트", cols);
}

...
<v-data-table
  ...
  <template v-slot:item="{ item }">
    <tr class="custom-th" style="height: 30px;">
      <td style="height: 30px; text-align: center;" @click="openPop(item.userId)">{{ item.userId}}</td>
      <td style="height: 30px; text-align: center;">{{ item.memberNm}}</td>
      <td style="height: 30px; ">{{ item.deptNm}}</td>
      <td style="height: 30px; text-align: center;">{{ item.jobPosition}}</td>
      <td style="height: 30px; text-align: center;">{{ item.phone}}</td>
      <td style="height: 30px; text-align: center;">{{ item.email}}</td>
      <td style="height: 30px; text-align: center;">{{ item.useYn === 'Y' ? '재직' : '퇴직'}}</td>
      <td style="height: 30px; ">{{ item.etc }}</td>
    </tr>
  </template>

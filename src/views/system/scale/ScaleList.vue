...
<div>
    <DataTable
        ...
        class="my-table"
        >
        <Column field="areaName"        header="구역(공장)" :style="{ width: '130px', textAlign: 'center'}" :pt="{ columnHeaderContent: 'justify-center' }"></Column>
        ...
        <Column field="scaleNickname"   header="저울별칭"   :style="{ width: '300px', textAlign: 'center'}" bodyClass="break-words"  :pt="{ columnHeaderContent: 'justify-center' }">
            <template #body="slotProps">
                <div @click="selectRowClick(slotProps.data.scaleId)" >
...
const srhList = async () =>{
    ...
    console.log('scaleList.value', scaleList.value)
}

        ...
        <div class="list-section mt-3">
          <div class="list-wrapper">
            ...
            >
              ...
              <Column field="purchaseOrerDateSeq"   header="발주일자" style="text-align: center;" :style="{ width: '80px'}":pt="{ columnHeaderContent: 'justify-center' }"/>
              ...
              <Column field="spec"  header="규격" style="text-align: left;" :style="{ width: '180px'}" :pt="{ columnHeaderContent: 'justify-center' }"/>
              <Column field="qty"   header="수량" style="text-align: left;" :style="{ width: '180px'}" :pt="{ columnHeaderContent: 'justify-center' }"/>
            </DataTable>
          </div>
        </div>

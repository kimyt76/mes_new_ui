...
<div>
    <DataTable
        ...
        <Column field="itemName"            header="품목명"    :style="{ width: '400px'}" bodyClass="break-words" :pt="{ columnHeaderContent: 'justify-center' }">
...
import PurchaseOrderPop from './PurchaseOrderPPop.vue';

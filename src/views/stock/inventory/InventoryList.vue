...
<div>
    <DataTable
        ...
        <Column field="storageName"         header="창고"     :style="{ width: '70px', textAlign:'center'}" />
        <Column field="poNo"                header="품목수"     :style="{ width: '110px', textAlign:'center'}" />
        ...
        <Column field="workOderDate"        header="제조일자"    :style="{ width: '80px', textAlign:'center'}" />
...
const downloadExcel = () =>{
  ...
  exportToExcel(workOrderList.value, "재고 리스트", cols);
}

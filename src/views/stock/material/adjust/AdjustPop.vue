...
const saveInfo = async () =>{
    ...
    if ( isEmpty(form.tranTypeCd)  ) return vWarning("처리구분을 선택하세요!!")
...
onMounted( async ()=>{
    tranTypeCds.value = (await ApiCommon.getCodeList('tran_cd')).filter(i => ['P','Q', 'R','S','T','U','V','W', 'X'].includes(i.code)  )

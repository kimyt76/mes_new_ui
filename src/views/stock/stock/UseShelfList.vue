...
<div>
    <DataTable
        ...
        <Column field="itemName"        header="시험번호"  frozen  :style="{ width: '300px'}" bodyClass="break-words" style="text-align: left;" :pt="{ columnHeaderContent: 'justify-center' }" />
        <Column field="shilfDate"        header="사용기한"  frozen  :style="{ width: '300px'}" bodyClass="break-words" style="text-align: left;" :pt="{ columnHeaderContent: 'justify-center' }" />
        <Column field="shilfDate"        header="잔여일"  frozen  :style="{ width: '300px'}" bodyClass="break-words" style="text-align: left;" :pt="{ columnHeaderContent: 'justify-center' }" />
        <Column field="sumDay"         header="합계"  frozen :pt="{ columnHeaderContent: 'justify-center' }" :style="{ width: '100px'}" style="text-align: right;">
...
const downloadExcel = () =>{
  ...
  exportToExcel(shilfList.value, "사용기한 리스트", cols);
}

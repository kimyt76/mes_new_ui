<template>
    <Card style="width: 85rem; height: 50rem;">
         <template #content>
            <div class="w-full overflow-x-auto">
                <div class="w-[800px] max-w-full ml-auto">
                    ...
                    <tr>
                        ...
                        <td class="approval-cell">{{ approvalInfo.labUserName }}</td>
                    </tr>
                    <tr>
            ...
            <div class="flex justify-end">
                <Button label="승인" class="p-button-secondary" @click="confirmApproval"></Button>
            </div>
    ...
    <div class="flex gap-2 justify-end pt-3">
        <Button label="수정"   outlined class="ml-2" @click="updateInfo"></Button>
